...
function menu_hook(title, tab) {
	tabtitle[tabtitle.length - 1] = new Array("", "软件中心", "离线安装", "VirtualHere 虚拟USB服务器");
	tablink[tablink.length - 1] = new Array("", "Main_Soft_center.asp", "Main_Soft_setting.asp", "Module_virtualhere.asp");
}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <i>配置文件保存路径 /jffs/softcenter/etc/vhusbd/vhusbd.ini</i>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
